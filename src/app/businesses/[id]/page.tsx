...
export default function BusinessDetailPage() {
    ...
    // PRIVACY CHECK: Only show approved businesses (or if owner - though owner check needs more logic)
    if (business.status !== 'approved') {
        return (
            <div className={styles.detailPage}>
                <div className={styles.statusContainer}>
                    <div className={styles.statusIcon}>⏳</div>
                    <h2 className={styles.statusTitle}>Business Under Review</h2>
                    <p className={styles.statusText}>
                        This business profile is currently being reviewed by our team.
                        It will be visible to the public once it has been approved.
                    </p>
                    <button onClick={() => router.push('/businesses')} className={styles.statusActionBtn}>
            ...
            <div className="container">
                <div className={styles.content}>
                    ...
                    <div className={styles.sidebar}>
                        ...
                        <div className={styles.card}>
                            ...
                            <div className={styles.infoItem}>
                                ...
                                <div>
                                    ...
                                    {business.streetAddresses && business.streetAddresses.length > 0 ? (
                                        business.streetAddresses.map((addr, i) => (
                                            <p key={i}>{addr}, {business.city}, {business.state} - {business.pincode}</p>
                                        ))
                                    ) : (
                        ...
                        {/* Social Links */}
                        {(business.websiteLink || business.facebookLink || business.instagramLink || business.twitterLink) && (
                            <div className={styles.card}>
                                <h3 className={styles.cardTitle}>Connect Online</h3>
                                <div className={styles.socialLinks}>
                                    {business.websiteLinks && business.websiteLinks.length > 0 ? (
                                        business.websiteLinks.map((link, i) => (
                                            <a key={i} href={link.startsWith('http') ? link : `https://${link}`} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                                    <circle cx="12" cy="12" r="10" />
                                                    <line x1="2" y1="12" x2="22" y2="12" />
                                                    <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" />
                                                </svg>
                                                Website {business.websiteLinks!.length > 1 ? i + 1 : ''}
                                            </a>
                                        ))
                                    ...
                                    {business.twitterLink && (
                                        <a href={business.twitterLink.startsWith('http') ? business.twitterLink : `https://${business.twitterLink}`} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
